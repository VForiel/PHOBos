...
Notes
-----
The system uses two types of coefficients:
- CUR_CONVERSION / VOLT_CONVERSION: Fixed hardware constants (DAC units per mA/V)
- CUR_CORRECTION / VOLT_CORRECTION: Calibrable per-channel multipliers (start at 1.0)

Use update_coeffs() to refine the correction coefficients for each channel.
DAC value = user_value * CONVERSION * CORRECTION[channel]
